# SiD_Magento_2
## SiD Secure EFT plugin v2.3.4 for Magento v2.3.5
...
Please navigate to the [releases page](https://github.com/SiD-Instant-EFT/SiD_Magento_2/releases), download the latest release (v2.3.4) and unzip. You will then be able to follow the integration guide PDF which is included in the zip.
