# SiD_Magento_2
## SiD Secure EFT plugin v2.4.3 for Magento v2.4.4
...
Please navigate to the [releases page](https://github.com/SiD-Secure-EFT/SiD_Magento_2/releases), download the latest release (v2.4.3) and unzip. You will then be able to follow the integration guide PDF which is included in the zip.
